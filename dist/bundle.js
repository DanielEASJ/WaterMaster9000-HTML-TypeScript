...
var loginTest = new _login__WEBPACK_IMPORTED_MODULE_2__["Login"]();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        if (tempReponse_1 != 0) {
                            document.cookie = "USERID=" + tempReponse_1.toString();
                            this.status = true;
                            window.location.href = "index.htm";
                        }
                        return [3 /*break*/, 3];
...
var NewSensor = /** @class */ (function (_super) {
    ...
    NewSensor.prototype.PostNewSensor = function () {
        ...
        if (inputName.value == "") {
            validation = false;
            content.appendChild(new _alert__WEBPACK_IMPORTED_MODULE_1__["Alert"]("Feltet \"Navn\" må IKKE være tomt!").MakeAlert());
        }
        if (inputLL.value != "" && inputLL.value.match("^[0-9]*$")) {
            if (Number(inputLL.value) < 0
                && Number(inputLL.value) > 100) {
                validation = false;
                content.appendChild(new _alert__WEBPACK_IMPORTED_MODULE_1__["Alert"]("Feltet \"Nedre fugtigheds-grænse\" SKAL være mellem 0-100!").MakeAlert());
            }
        }
        else {
            validation = false;
            content.appendChild(new _alert__WEBPACK_IMPORTED_MODULE_1__["Alert"]("Feltet \"Nedre fugtigheds-grænse\" må IKKE være tomt, og må KUN indeholde tal!").MakeAlert());
        }
        if (inputUL.value != "" && inputUL.value.match("^[0-9]*$")) {
            if (Number(inputUL.value) < 0
                && Number(inputUL.value) > 100) {
                validation = false;
                content.appendChild(new _alert__WEBPACK_IMPORTED_MODULE_1__["Alert"]("Feltet \"Øvre fugtigheds-grænse\" SKAL være mellem 0-100!").MakeAlert());
            }
        }
        else {
            validation = false;
            content.appendChild(new _alert__WEBPACK_IMPORTED_MODULE_1__["Alert"]("Feltet \"Øvre fugtigheds-grænse\" må IKKE være tomt, og må KUN indeholde tal!").MakeAlert());
        }
        if (Number(inputLL.value) > Number(inputUL.value)) {
            validation = false;
            content.appendChild(new _alert__WEBPACK_IMPORTED_MODULE_1__["Alert"]("Den \"Nedre fugtigheds-grænse\" må IKKE være større end den øvre fugtigheds-grænse!").MakeAlert());
        }
...
var Sensors = /** @class */ (function (_super) {
    ...
    Sensors.prototype.SetUpHTML = function (sensor) {
        ...
        var phumidity = cardBody.appendChild(document.createElement("p"));
        phumidity.innerText = "Fugtighed: ";
        var spanhumidity = phumidity.appendChild(document.createElement("span"));
        var pdate = cardBody.appendChild(document.createElement("p"));
        ...
        var spanlimitlow = plimitlow.appendChild(document.createElement("span"));
